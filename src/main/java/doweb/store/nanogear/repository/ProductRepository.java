package doweb.store.nanogear.repository;
...
import doweb.store.nanogear.dto.ProductCategoryCount;
...
//	List<Product> findProductDetailType(@Param("id") int idCategory);
	...
	@Query("select new doweb.store.nanogear.dto.ProductCategoryCount( o.category.name, count(o)) from Product o group by o.category.id, o.category.name")
...
//	@Query("SELECT new doweb.store.nanogear.dto.Report(o.category, sum(o.price), count(o)) "
//			+ " FROM Product o "
//			+ " GROUP BY o.category"
